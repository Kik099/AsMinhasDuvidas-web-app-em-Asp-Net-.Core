        ...
        public static void Main(string[] args)
        {
            ...
            using (var scope = host.Services.CreateScope())
            {
                ...
                try
                {
                    ...
                    MigrationManager.SeedData(services.GetService<UserManager<ApplicationUser>>(), services.GetService<RoleManager<IdentityRole>>(), context);
                }
                catch (Exception ex)
                {
                    var logger = services.GetRequiredService<ILogger<Program>>();
                    logger.LogError(ex, "Base de dados não foi implementada");
                }
            }
